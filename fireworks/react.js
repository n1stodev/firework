...
let colors = ['#f00', '#fff', '#16d704', '#ff4081', '#7c4dff', '#e040fb'];
...
function newShell(){
    ...
    shell.x = (1*left);
    shell.y = 1;
    shell.xoff = (0.01 + random() * 0.007) * (left ? 1: -1);
    shell,yoff = 0.01 + random() * 0.007;
    shell.size = Math.random() * 6 + 3;
    shell.color = colors[Math.floor(Math.random() * color.length )];
